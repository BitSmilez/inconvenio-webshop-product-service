...
public class CreateProducts {
    ...
    public  void createProducts(){
        ...
        boots.setPrice(new BigDecimal("420.00"));
        ...
        mug.setName("THE mug");
        mug.setPrice(new BigDecimal("420.00"));
        mug.setSalesPrice(new BigDecimal("69.69"));
        ...
        wineGlass.setSalesPrice(new BigDecimal("69.69"));
        ...
        champagneGlass.setPrice(new BigDecimal("420.00"));
        boots.setSalesPrice(null);
        ...
        fork.setPrice(new BigDecimal("420.00"));
        fork.setSalesPrice(new BigDecimal("69.69"));
